...
public class DepartmentsController : ControllerBase
{
    ...
    public DepartmentsController(StudentProfileDbContext context)
    {
        _context = context;
    }
    ...
    {
        var department = await _context.Departments.Include(d => d.Faculty).FirstOrDefaultAsync(d => d.DepartmentId == id);
